...
INSERT INTO Contact 
VALUES ('Avec notre savoir-faire toutes les fantaisies sont possibles : vous pouvez personnaliser à votre guise le moindre détail jusqu’à la boîte du gâteau. Laissez-vous donc guider et découvrez la variété des parfums possibles. Nous avons sélectionné des mariages parmi une large variété de saveurs. Avez-vous rêvé de créer un gâteau complètement unique qui correspond à vos goûts et à vos besoins? Avec cette application c’est désormais possible! Pimp my cake vous permet de confectionner le gâteau de vos rêves. ')